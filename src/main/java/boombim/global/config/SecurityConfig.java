package boombim.global.config;


import boombim.domain.oauth2.infra.filter.BoombimJWTFilter;
import boombim.domain.oauth2.infra.filter.BoombimLogoutFilter;
import boombim.global.infra.exception.auth.BoombimAuthExceptionFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .addFilterAt(new BoombimLogoutFilter(jwtUtil, jsonWebTokenRepository, KakaoJsonWebTokenRepository), LogoutFilter.class);
