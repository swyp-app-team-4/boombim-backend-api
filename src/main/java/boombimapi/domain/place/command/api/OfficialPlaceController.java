...
import boombimapi.domain.place.command.service.OfficialPlaceService;
...
//    }
    ...
    @GetMapping({"/app/public/official-place/{officialPlaceId}/overview", "/app/official-place/{officialPlaceId}/overview"})
    ...
    @GetMapping({"/app/public/official-place/nearby-non-congested", "/app/official-place/nearby-non-congested"})
    ...
    @GetMapping({"/app/public/official-place/top-congested", "/app/official-place/top-congested"})
