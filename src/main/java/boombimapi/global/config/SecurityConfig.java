    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .cors((cors) -> cors.configurationSource(request -> {
                    ...
                    config.setAllowedOriginPatterns(List.of("https://boombim.netlify.app"));
                ...
                .authorizeHttpRequests((url) -> url
                        ...
                        .requestMatchers("/api/app/oauth2/login/**")
                ...
                .addFilterAfter(new BoombimJWTFilter(jwtUtil, excludedUrls),
